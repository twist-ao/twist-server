...
'        azar = 1
    ...
    Case 3
        ...
        Call SendData(SendTarget.ToMap, npcind, Npclist(npcind).Pos.Map, "CXF" & Npclist(npcind).char.CharIndex & "," & FXIDs.FXMEDITARFULL & "," & LoopAdEternum)
...
On Error GoTo errorh
    ...
    Call SendData(SendTarget.ToNPCArea, NPCAlInd, Npclist(NPCAlInd).Pos.Map, "CXF" & Npclist(NPCAlInd).char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops & "," & Hechizos(indireccion).WAV)
...
On Error GoTo errorh
    ...
    Call SendData(SendTarget.ToNPCArea, Paralizado, Npclist(Paralizado).Pos.Map, "CXF" & Npclist(Paralizado).char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops & "," & Hechizos(indireccion).WAV)
...
On Error GoTo errorh
    ...
    Call SendData(SendTarget.ToNPCArea, curado, Npclist(curado).Pos.Map, "CXF" & Npclist(curado).char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops & "," & Hechizos(indireccion).WAV)
...
On Error GoTo errorh
    ...
    '' Envia las palabras magicas, fx y wav del indice-esimo hechizo del npc-hostiles.dat
    Call SendData(SendTarget.ToNPCArea, npcind, Npclist(npcind).Pos.Map, ServerPackages.dialogo & vbCyan & "° " & Hechizos(indireccion).PalabrasMagicas & " °" & str(Npclist(npcind).char.CharIndex))
    Call SendData(SendTarget.ToPCArea, PJEnInd, UserList(PJEnInd).Pos.Map, "CXF" & UserList(PJEnInd).char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops & "," & Hechizos(indireccion).WAV)
...
On Error GoTo errorh
    ...
    '' Envia las palabras magicas, fx y wav del indice-esimo hechizo del npc-hostiles.dat
    Call SendData(SendTarget.ToNPCArea, npcind, Npclist(npcind).Pos.Map, ServerPackages.dialogo & vbCyan & "° " & Hechizos(indireccion).PalabrasMagicas & " °" & str(Npclist(npcind).char.CharIndex))
    Call SendData(SendTarget.ToPCArea, PJEnInd, UserList(PJEnInd).Pos.Map, "CXF" & UserList(PJEnInd).char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops + 4 & "," & Hechizos(indireccion).WAV)
            ...
            For X = 8 To 95
                For Y = 8 To 95
                    ...
                    If PJInd > 0 Then
                        ...
                        Call SendData(SendTarget.ToPCArea, PJInd, UserList(PJInd).Pos.Map, "CXF" & UserList(PJInd).char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops & "," & Hechizos(indireccion).WAV)
                    ...
                    ElseIf (MascotaInd > 0) Then
                        If (Npclist(MascotaInd).MaestroUser > 0) Then
                            ...
                            Call SendData(SendTarget.ToNPCArea, MascotaInd, Npclist(MascotaInd).Pos.Map, "CXF" & Npclist(MascotaInd).char.CharIndex & "," & Hechizos(indireccion).FXgrh & "," & Hechizos(indireccion).loops & "," & Hechizos(indireccion).WAV)
